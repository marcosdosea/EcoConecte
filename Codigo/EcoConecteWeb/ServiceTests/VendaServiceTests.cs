...
namespace Service.Tests
{
    ...
    public class VendaServiceTests
    {
        ...
        public void Initialize()
        {
            ...
            var venda = new List<Vendamaterial>
            {
                new Vendamaterial {Id= 1, Tipo= "Plastico", Valor= "R$ 100", Quantidade="50 Kg"},
                new Vendamaterial {Id= 2, Tipo= "Metal", Valor= "R$ 500", Quantidade="25 Kg"},
                new Vendamaterial {Id= 3, Tipo= "Vidro", Valor= "R$ 1100", Quantidade="45 Kg"}
            };
        ...
        {
            //act
            _vendaService.Create(new Vendamaterial { Id = 4, Tipo = "Vidro", Valor = "R$ 100", Quantidade = "2 Kg", });
            //Assert
        ...
        public void GetAllTest()
        {
            ...
            //Assert
            Assert.IsInstanceOfType(listaVenda, typeof(IEnumerable<Vendamaterial>));
